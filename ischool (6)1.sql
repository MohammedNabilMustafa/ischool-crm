...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2022 at 08:51 AM
...
INSERT INTO `employee` (`employee_id`, `timestamp`, `emp_name`, `phone`, `email`, `zoomlink`, `username`, `password_value`, `permission_id`, `department_id`, `role_id`, `zoom_free`) VALUES
...
(550, '2022-03-20', 243, 21480, 5370, 'waiting', '2022-04-01', '0000-00-00', 0, '', 180, 12, 0),
...
(152, '2022-03-20', 'Mohamed Nabil Mustafa', '01027713442', 'mohammed.nabil.mustafa@gmail.com', '', '', '', '', 'eg', '', 0, 14, 15, 'mohammed.nabil.mustafa@gmail.com', '01027713442');
...
INSERT INTO `students` (`students_id`, `timestamp`, `std_id`, `parent_id`, `free_session_status`, `std_status`, `st_name`, `age`, `birthdate`) VALUES
...
--
ALTER TABLE `students`
  MODIFY `students_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;
