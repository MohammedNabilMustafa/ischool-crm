...
var paper_inputs_label = [
    ...
    get_student_groups_tables(All_req_obj ,quary_tables_all_status_add_student_package , '' , time_out  , 1);
...
function get_student_package_tables(All_req_obj , func_quary,func , timeout , index_pos , paper_inputs)
{
 ...
 function again_student_group_package(All_table_obj , arr_data , func_quary ,  func , timeout , index_pos , All_req_obj , paper_inputs )
 {
